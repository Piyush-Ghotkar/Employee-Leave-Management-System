...
if($dept=="Civil Engineering"){
	header('location:FE_clearence.php?branch=Civil Engineering');
}
else if($dept=="Mechanical Engineering"){
	header('location:FE_clearence.php?branch=Mechanical Engineering');
}
else if($dept=="Computer Engineering"){
	header('location:FE_clearence.php?branch=Computer Engineering');
}
else if($dept=="Electrical Engineering"){
	header('location:FE_clearence.php?branch=Electrical Engineering');
}
else if($dept=="Backlog Students"){
	header('location:FE_clearence.php?branch=Backlog Students');
}
