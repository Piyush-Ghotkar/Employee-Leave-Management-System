                ...
                <main class="mn-inner"> <div class="example1">
                    				...
                    				<div class="nav">
									  <ul id="main-menu">
										...
										<li class="active"><a href="FE_clearence_app.php?branch=<?php echo $dept?>">Approved Students</a></li>
										<li><a href="FE_clearence_napp.php?branch=<?php echo $dept?>">Non-Approved Students</a></li>
									  </ul>
									</div>	</center>
									<br>
									<br>
