...
?>
			...
			<?php if($val2[0]!="LIB"){?>
                <main class="mn-inner"> <div class="example1">
									...
									<br>
									<div class="container">
									  <h2><BR>All Students <font size="6px">(<?php echo htmlentities ($print);?>)</font></h2>
...
if($show=="all"){
	$sql ="SELECT * FROM $batch WHERE department='Civil Engineering' ORDER BY id ASC";
}elseif($show=="app"){
	$sql ="SELECT * FROM $batch WHERE department='Civil Engineering' and library_remark=1 ORDER BY id ASC";
} elseif($show=="napp"){
	$sql ="SELECT * FROM $batch WHERE department='Civil Engineering' and library_remark!=1 ORDER BY id ASC";
}
$query = $dbh -> prepare($sql);
