				...
				<center>
                    				<div class="nav">
									  <ul id="main-menu">
										...
										<li class="active"><a href="HOD_clearence_app.php?year=<?php echo $year?>">Approved Students</a></li>
									...
									<br>
									<div class="container">
									  <h2><BR>Approved Students  <font size="6px">(<?php echo htmlentities ($print);?>)</font></h2>
