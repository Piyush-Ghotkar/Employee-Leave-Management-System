...
if($year==1){$print="First Year";}
	   ...
	   ?>
				...
				<center>
                    				<div class="nav">
									  <ul id="main-menu">
										<li><a href="HOD_clearence.php?year=<?php echo $year?>">All Students<br></a></li>
									    <li><a href="HOD_clearence_app.php?year=<?php echo $year?>">Approved Students</a></li>
										<li class="active"><a href="HOD_clearence_napp.php?year=<?php echo $year?>">Non-Approved Students</a></li>
									  </ul>
									</div>	</center>
									<br>
									<br>
									<div class="container">
									  <h2><BR>Non-Approved Students  <font size="6px">(<?php echo htmlentities ($print);?>)</font></h2>
