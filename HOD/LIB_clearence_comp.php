...
<!--else part for library-->		
		                ...
		                <main class="mn-inner"> <div class="example1">
                    				...
                    				<div class="nav">
									  <ul id="main-menu">
										<li><a href="HOD_clearence.php?year=<?php echo $year?>&show=all">Civil Enginnering<br></a></li>
										<li><a href="LIB_clearence_mech.php?year=<?php echo $year?>&show=all">Mechanical Enginnering</a></li>
										<li class="active"><a href="LIB_clearence_comp.php?year=<?php echo $year?>&show=all">Computer Enginnering</a></li>
										<li><a href="LIB_clearence_ele.php?year=<?php echo $year?>&show=all">Electrical Enginnering<br></a></li>
									  </ul>
									</div></center>
									<br>
									<br>
...
if($show=="all"){
	$sql ="SELECT * FROM $batch WHERE department='Computer Engineering' ORDER BY id ASC";
}elseif($show=="app"){
	$sql ="SELECT * FROM $batch WHERE department='Computer Engineering' and library_remark=1 ORDER BY id ASC";
} elseif($show=="napp"){
	$sql ="SELECT * FROM $batch WHERE department='Computer Engineering' and library_remark!=1 ORDER BY id ASC";
