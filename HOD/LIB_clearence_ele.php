...
if($show=="all"){
	$sql ="SELECT * FROM $batch WHERE department='Electrical Engineering' ORDER BY id ASC";
}elseif($show=="app"){
	$sql ="SELECT * FROM $batch WHERE department='Electrical Engineering' and library_remark=1 ORDER BY id ASC";
} elseif($show=="napp"){
	$sql ="SELECT * FROM $batch WHERE department='Electrical Engineering' and library_remark!=1 ORDER BY id ASC";
