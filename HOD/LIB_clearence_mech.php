...
if($show=="all"){
	$sql ="SELECT * FROM $batch WHERE department='Mechanical Engineering' ORDER BY id ASC";
}elseif($show=="app"){
	$sql ="SELECT * FROM $batch WHERE department='Mechanical Engineering' and library_remark=1 ORDER BY id ASC";
} elseif($show=="napp"){
	$sql ="SELECT * FROM $batch WHERE department='Mechanical Engineering' and library_remark!=1 ORDER BY id ASC";
