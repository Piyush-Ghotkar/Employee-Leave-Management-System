			...
			<?php if($val2[0]!="LIB"){?>
                <main class="mn-inner"> <div class="example1">
                    				...
                    				<div class="nav">
									  <ul id="main-menu">
									  <?php if($show=="all"){?> 
										<li class="active"><a href="dc_stu_clearance.php?show=all">All Students<br></a></li>
										<li><a href="dc_stu_clearance.php?show=app">Approved Students</a></li>
										<li><a href="dc_stu_clearance.php?show=napp">Non-Approved Students</a></li>
									  <?php }else if($show=="app"){?>
										<li><a href="dc_stu_clearance.php?show=all">All Students<br></a></li>
										<li class="active"><a href="dc_stu_clearance.php?show=app">Approved Students</a></li>
										<li><a href="dc_stu_clearance.php?show=napp">Non-Approved Students</a></li>
									  <?php }else if($show=="napp"){?>
										<li><a href="dc_stu_clearance.php?show=all">All Students<br></a></li>
										<li><a href="dc_stu_clearance.php?show=app">Approved Students</a></li>
										<li class="active"><a href="dc_stu_clearance.php?show=napp">Non-Approved Students</a></li>
									  <?php }?>
									  </ul>
									</div>	</center>
									<br>
...
{  
	...
	if($val2[0]=="FE" and $result1->ac_year==1){
		...
		if($show=="all"){
			$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and department='$dept' ORDER BY id ASC";
		}elseif($show=="app"){
			$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and department='$dept' and HOD_remark=1 ORDER BY id ASC";
		} elseif($show=="napp"){
			$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and department='$dept' and HOD_remark!=1 ORDER BY id ASC";
		}		
	}	
...
{   
	...
	if($show=="all"){
		echo "adfadf=$year 	";
		$sql ="SELECT * FROM $batch WHERE ac_year<'$year' ORDER BY id ASC";
	}elseif($show=="app"){
		$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and library_remark=1 ORDER BY id ASC";
	} elseif($show=="napp"){
		$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and library_remark!=1 ORDER BY id ASC";
	}		
