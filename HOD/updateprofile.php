...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Designation=:designation,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmpId=:eid";
