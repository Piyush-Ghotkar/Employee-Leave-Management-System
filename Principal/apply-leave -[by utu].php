...
<select  name="leavetype" autocomplete="off" onChange="mydate();">
...
<input type="text" name="fromdate" id="ndt"  onclick="mydate();" hidden />
</div>

<div class="input-field col m6 s12">
Todate:
<input type="date"  id="dt2" onchange="mydate2();" hidden />
<input type="text" name="todate" id="ndt2"  onclick="mydate();" hidden />
</div>
