...
$sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Full_Leave,Half_Leave,Description,Status,IsRead,empid,aid) VALUES(:leavetype,:todate,:fromdate,:radio,:half,:description,:status,:isread,:empid,:aid)";
