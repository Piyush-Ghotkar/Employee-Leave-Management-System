...
header('location:index.php');
	...
	$t="Principal";
	$sql1="SELECT id from tblemployees WHERE EmpId='$t'";
	$r2=$conn -> query($sql1);
	$r1=$r2 -> fetch_assoc();
	$_SESSION['pid']=$r1['id'];
?>
