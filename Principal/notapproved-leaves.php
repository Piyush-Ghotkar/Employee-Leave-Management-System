...
<?php 
$status=2;
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.P_Status from tblleaves join tblemployees on (tblleaves.aid=tblemployees.id) OR (tblleaves.empid=tblemployees.id) where tblleaves.P_Status=:status order by lid desc";
