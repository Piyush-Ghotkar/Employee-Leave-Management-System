...
?>
              ...
              <main class="mn-inner"><div class="example1">
                    				...
                    				<div class="nav">
									  <ul id="main-menu">
										<li class="active"><a href="HOD_clearence.php?year=<?php echo $year?>&show=all">Civil Engineering<br></a></li>
							...
							<form method="POST" action="LIB_clearence_action.php?batch=<?php echo $batch?>"> 		  
...
if($show=="all"){
	$sql ="SELECT * FROM $batch WHERE department='Civil Engineering' and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
}elseif($show=="app"){
	$sql ="SELECT * FROM $batch WHERE department='Civil Engineering' and account_remark=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
} elseif($show=="napp"){
	$sql ="SELECT * FROM $batch WHERE department='Civil Engineering' and account_remark!=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
}
