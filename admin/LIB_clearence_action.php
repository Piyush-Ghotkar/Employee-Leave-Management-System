...
$batch=$_GET['batch'];
	...
	$year=$_SESSION['year'];
	if($year==1){
		header('location:HOD_clearence.php?year=1&show=all');
	}
	else if($year==2){
		header('location:HOD_clearence.php?year=2&show=all');
	}
	else if($year==3){
		header('location:HOD_clearence.php?year=3&show=all');
	}
	else if($year==4){
		header('location:HOD_clearence.php?year=4&show=all');
	}
	else if($year==0){
		header('location:HOD_clearence.php?year=0&show=all');
	}
