              ...
              <main class="mn-inner"><div class="example1">
                    				...
                    				<div class="nav">
									  <ul id="main-menu">
										...
										<li><a href="LIB_clearence_comp.php?year=<?php echo $year?>&show=all">Computer Engineering</a></li>
										<li class="active"><a href="LIB_clearence_ele.php?year=<?php echo $year?>&show=all">Electrical Engineering<br></a></li>
									  </ul>
									</div></center>
									<br>
									<br>
							...
							<form method="POST" action="LIB_clearence_ele_action.php?batch=<?php echo $batch?>"> 		  
...
if($show=="all"){
	$sql ="SELECT * FROM $batch WHERE department='Electrical Engineering' and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
}elseif($show=="app"){
	$sql ="SELECT * FROM $batch WHERE department='Electrical Engineering' and account_remark=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
} elseif($show=="napp"){
	$sql ="SELECT * FROM $batch WHERE department='Electrical Engineering' and account_remark!=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
}
