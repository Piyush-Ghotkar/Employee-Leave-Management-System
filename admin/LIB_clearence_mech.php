              ...
              <main class="mn-inner"><div class="example1">
                    				...
                    				<div class="nav">
									  <ul id="main-menu">
										...
										<li class="active"><a href="LIB_clearence_mech.php?year=<?php echo $year?>&show=all">Mechanical Engineering</a></li>
							...
							<form method="POST" action="LIB_clearence_mech_action.php?batch=<?php echo $batch?>"> 		  
...
if($show=="all"){
	$sql ="SELECT * FROM $batch WHERE department='Mechanical Engineering' and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
}elseif($show=="app"){
	$sql ="SELECT * FROM $batch WHERE department='Mechanical Engineering' and account_remark=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
} elseif($show=="napp"){
	$sql ="SELECT * FROM $batch WHERE department='Mechanical Engineering' and account_remark!=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
}
