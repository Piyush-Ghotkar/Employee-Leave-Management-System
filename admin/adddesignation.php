...
if(isset($_POST['add']))
{
$designation=$_POST['leavetype'];
$teaching=$_POST['teaching'];
$dept=$_POST['department'];
$sql="INSERT INTO tbldesignation(teaching,department,designation) VALUES(:teaching,:dept,:designation)";
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add New Designation</div>
                    </div>
...
<div class="input-field col s12">
<input type="radio" name="teaching" value="yes" required> &nbsp Teaching &nbsp &nbsp &nbsp  &nbsp &nbsp
<input type="radio" name="teaching" value="no"> &nbsp Non-Teaching
</div>
