                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Totle Regd Faculties</span>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status,tblleaves.P_Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.id order by lid desc limit 6";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
      ...
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->PostingDate);?></td>
                                                                       <td><?php $Pstats=$result->P_Status; $stats=$result->Status;
if($Pstats==1){
                                             ?>
                                                 <span style="color: green">Approved</span>
                                                 <?php } if($Pstats==2 or $stats==2)  { ?>
                                                <span style="color: red">Not Approved</span>
                                                 <?php } if(($stats==1 and $Pstats==0) or $stats==0)  { ?>
