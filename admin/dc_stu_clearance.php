...
{   
	...
	if($show=="all"){
		$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
	}elseif($show=="app"){
		$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and account_remark=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
	} elseif($show=="napp"){
		$sql ="SELECT * FROM $batch WHERE ac_year<'$year' and account_remark!=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
	}		
