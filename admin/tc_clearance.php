...
?>
			...
			<main class="mn-inner"> <div class="example1">
                    				...
                    				<div class="nav">
									  <ul id="main-menu">
									  <?php if($show=="all"){?> 
										<li class="active"><a href="tc_clearance.php?show=all">All Students<br></a></li>
										<li><a href="tc_clearance.php?show=app">Approved Students</a></li>
										<li><a href="tc_clearance.php?show=napp">Non-Approved Students</a></li>
									  <?php }else if($show=="app"){?>
										<li><a href="tc_clearance.php?show=all">All Students<br></a></li>
										<li class="active"><a href="tc_clearance.php?show=app">Approved Students</a></li>
										<li><a href="tc_clearance.php?show=napp">Non-Approved Students</a></li>
									  <?php }else if($show=="napp"){?>
										<li><a href="tc_clearance.php?show=all">All Students<br></a></li>
										<li><a href="tc_clearance.php?show=app">Approved Students</a></li>
										<li class="active"><a href="tc_clearance.php?show=napp">Non-Approved Students</a></li>
									  <?php }?>
									  </ul>
									</div>	</center>
									<br>
...
{   
	...
	if($show=="all"){
		$sql ="SELECT * FROM $batch WHERE HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
	}elseif($show=="app"){
		$sql ="SELECT * FROM $batch WHERE account_remark=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
	} elseif($show=="napp"){
		$sql ="SELECT * FROM $batch WHERE account_remark!=1 and HOD_remark=1 and library_remark=1 and sports_remark=1 and scholarship_remark=1 ORDER BY id ASC";
	}		
