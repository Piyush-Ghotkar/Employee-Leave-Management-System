                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">| ADMINSTRATION |</span>
                        </div>
...
<?php 
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.Department,tblemployees.LastName,tblemployees.EmpId,tblleaves.PostingDate,tblleaves.P_Status,tblleaves.empid,tblleaves.aid,tblleaves.IsRead from tblleaves join tblemployees on tblleaves.aid=tblemployees.id where tblleaves.IsRead=2";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
foreach($results as $result)
{ 
    if( $result->IsRead==2 and $result->aid==$eid1){ ?>
									<li>
