                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200">Principal Remark</th>
                                            <th>Status</th>
                                        </tr>
                                    </thead>
...
<?php 
$aid=$_SESSION['aid'];
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from tblleaves where aid=:aid order by id desc";
