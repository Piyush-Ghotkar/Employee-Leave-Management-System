...
//echo "rrm=$fromdate, to=$todate";
//echo "radio=$radio half=$half";
...
$sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Full_Leave,Half_Leave,Duty_Adj,Description,Status,IsRead,empid) VALUES  (:leavetype,:todate,:fromdate,:radio,:half,:adj,:description,:status,:isread,:empid)";
...
<div class="input-field col m6 s12">
Fromdate:
<input id="frmdt" name="fromdate" class="masked" type="date" required>
</div>

<div class="input-field col m6 s12">
Todate:
<input id="tdt" name="todate" class="masked" type="date" required>
</div>
