...
?>              
    <li class="table-row">
      ...
      <div class="col col-3"  data-label="link"><a target="_blank" href="notice/download_notice.php?refno=<?php echo $result->refno?>&date=<?php echo $result->date?>&title=<?php echo $result->title?>&body=<?php echo $result->body?>">Download</a></div>
