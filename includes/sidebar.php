     <aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    ...
                    <?php 
$eid=$_SESSION['eid'];
$sql = "SELECT FirstName,LastName,Designation,Department from  tblemployees where id=:eid";
...
{               ?>  
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="f_notice.php"><i class="material-icons">desktop_windows</i>Notice</a></li>				
