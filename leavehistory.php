...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status,P_Status from tblleaves where empid=:eid";
...
if($stats==1){
 ...
 <?php } ?>
																				...
																				<td><?php $P_stats=$result->P_Status;
																				
if($P_stats==1 and $stats==1){
                                             ?>
                                                 <span style="color: green">Approved</span>
                                                 <?php 	
												 } if($P_stats==2 and $stats==1)  { ?>
                                                <span style="color: red">Not Approved</span>
                                                 <?php } if($stats==2 and $P_stats==0)  { ?>
												<span style="color: black">N/A</span>
												<?php }  if($P_stats==0 and ($stats==0 or $stats==1 ))  { ?>
												<span style="color: blue">waiting for approval</span>
												<?php }?>
